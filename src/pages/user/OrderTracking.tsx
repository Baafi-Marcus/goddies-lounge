...
import { FaBoxOpen, FaMotorcycle, FaCheckCircle, FaClock, FaPhone, FaTools, FaHistory, FaShoppingBag, FaExclamationTriangle, FaQrcode, FaMapMarkerAlt } from 'react-icons/fa';
