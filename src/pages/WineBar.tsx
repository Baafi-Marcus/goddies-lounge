...
const WineBar: React.FC = () => {
    ...
    const categories = Array.from(new Set(wineData.map((item) => item.category)));
    ...
    const categoryItems = selectedCategory
        ? wineData.filter((item) => item.category === selectedCategory)
        : [];
        ...
        <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {categories.map((category) => {
                    ...
                    const categoryImage = wineData.find(item => item.category === category)?.image;
                                    ...
                                    <div className="md:w-1/2 flex flex-col">
                                        ...
                                        <div className="mt-auto">
                                            <div className="flex items-center justify-between mb-6">
                                                <span className="text-3xl font-bold text-brand-dark">₵{selectedItem.price.toFixed(2)}</span>
