...
import { FaUser, FaMotorcycle, FaLock, FaEdit, FaSave, FaTimes, FaSignOutAlt, FaToggleOn, FaToggleOff } from 'react-icons/fa';
import { updatePassword, EmailAuthProvider, reauthenticateWithCredential } from 'firebase/auth';
import { auth } from '../../services/firebase';

const RiderSettings: React.FC = () => {
            ...
            <div className="container mx-auto max-w-3xl">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                    <div className="flex items-center gap-4 mb-4">
                        <div className="w-16 h-16 bg-brand-dark text-white rounded-full flex items-center justify-center text-2xl">
                            <FaUser />
                        </div>
                        <div className="flex-grow">
                            <h1 className="text-2xl font-bold text-gray-900">{currentRider.name}</h1>
                            <p className="text-gray-500">{currentRider.phone}</p>
                        </div>
                        <button
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-lg font-bold transition-colors ${isOnline ? 'bg-green-100 text-green-700' : 'bg-gray-200 text-gray-600'
                                }`}
                        >
